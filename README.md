...
| `minimal_python_version`  |            `3.7`            | Minimal Python version. One of `3.7`, `3.8`, `3.9` and `3.10`. It is used for builds, GitHub workflow and formatters (`black`, `isort` and `pyupgrade`).                                            |
